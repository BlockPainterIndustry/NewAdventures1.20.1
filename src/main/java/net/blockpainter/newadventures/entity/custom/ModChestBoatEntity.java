...
public class ModChestBoatEntity extends ChestBoat {
    ...
    public ModChestBoatEntity(Level pLevel, double pX, double pY, double pZ) {
        this(ModEntities.YIRA_CHEST_BOAT.get(), pLevel); // Replace with your desired default
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, 0); // Default variant
    }
    ...
    protected void readAdditionalSaveData(CompoundTag pCompound) {
        if (pCompound.contains("Type", CompoundTag.TAG_STRING)) {
